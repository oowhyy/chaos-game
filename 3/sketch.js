...
function setup() {
  ...
  stopB = createButton('stop').position(width-dh,35).style('width','100px').style('height','22px');
  saveB = createButton('save').position(width-dh+100,5).style('width','50px').style('height','30px');
  ...
  saveB.mousePressed(function(){save(mainChaos.canv.get(),'ChaosFractal '+mainChaos.n+
  ' '+mainChaos.percent+
